...
const WHY_CARDS = [
  { icon: Zap, title: 'Save Time', description: 'Reduce email management from hours to minutes with AI automation that handles the heavy lifting.', iconBg: 'rgba(37, 99, 235, 0.15)', iconColor: '#38BDF8', borderColor: 'rgba(37, 99, 235, 0.3)' },
  { icon: Bot, title: 'AI Powered', description: 'Powered by Google Gemini and LangGraph — the most advanced AI models for natural language understanding.', iconBg: 'rgba(168, 85, 247, 0.15)', iconColor: '#C084FC', borderColor: 'rgba(168, 85, 247, 0.3)' },
  { icon: Lock, title: 'Secure & Private', description: 'Enterprise-grade OAuth 2.0, encrypted storage, and zero data sharing. Your emails stay yours.', iconBg: 'rgba(34, 197, 94, 0.15)', iconColor: '#4ADE80', borderColor: 'rgba(34, 197, 94, 0.3)' },
];
...
const TRUSTED_LOGOS = [
  ...
  { name: 'PostgreSQL', svg: (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="#38BDF8">
  ...
  { name: 'LangGraph', svg: (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="#38BDF8">
      ...
      <line x1="6" y1="8.5" x2="12" y2="15.5" stroke="#38BDF8" strokeWidth="1.5"/><line x1="18" y1="8.5" x2="12" y2="15.5" stroke="#38BDF8" strokeWidth="1.5"/><line x1="8.5" y1="6" x2="15.5" y2="6" stroke="#38BDF8" strokeWidth="1.5"/>
    </svg>
  )},
];
...
function LogoMark({ className = 'h-8 w-8' }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <rect x="8" y="16" width="26" height="18" rx="3" fill="#FAFAFA" opacity="0.95"/>
      ...
      <path d="M30 6 L30.8 8.5 L33 9.2 L30.8 10 L30 12.5 L29.2 10 L27 9.2 L29.2 8.5 Z" fill="#FAFAFA" opacity="0.8"/>
      <circle cx="42" cy="22" r="1.5" fill="#FAFAFA" opacity="0.6"/>
    </svg>
  );
}
        ...
        <div className="p-4 space-y-3" style={{ background: '#09090B' }}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg p-2.5 flex items-center gap-2" style={{ background: '#18181B', border: '1px solid #27272A' }}>
              <div className="h-7 w-7 rounded-lg flex items-center justify-center" style={{ background: 'rgba(37, 99, 235, 0.15)' }}>
            ...
            <div className="rounded-lg p-2.5 flex items-center gap-2" style={{ background: '#18181B', border: '1px solid #27272A' }}>
              <div className="h-7 w-7 rounded-lg flex items-center justify-center" style={{ background: 'rgba(56, 189, 248, 0.15)' }}>
          ...
          <div className="rounded-lg overflow-hidden" style={{ background: '#18181B', border: '1px solid #27272A' }}>
            <div className="px-3 py-2 flex items-center justify-between" style={{ borderBottom: '1px solid #27272A' }}>
              ...
              <p className="text-[8px]" style={{ color: '#38BDF8' }}>View All</p>
            </div>
            {[
              ...
              <div key={i} className="px-3 py-2 flex items-center gap-2" style={{ borderBottom: i < 3 ? '1px solid #27272A' : 'none' }}>
                <div className="h-6 w-6 rounded-full flex items-center justify-center text-[8px] font-semibold shrink-0" style={{ background: 'rgba(37, 99, 235, 0.15)', color: '#38BDF8' }}>
                  {email.from.charAt(0)}
                </div>
...
function SectionHeading({ tag, title, description }: { tag: string; title: string; description: string }) {
  return (
    ...
    >
      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium mb-4" style={{ background: 'rgba(37, 99, 235, 0.15)', color: '#38BDF8', border: '1px solid rgba(56, 189, 248, 0.3)' }}>
        <Sparkles className="h-3 w-3" />
        {tag}
      </span>
      <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4" style={{ color: '#FAFAFA' }}>
        {title}
      </h2>
...
export default function LoginPage() {
  ...
  return (
    <div className="landing min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="#" className="flex items-center gap-2.5 shrink-0">
              ...
              <span className="text-base font-bold tracking-tight" style={{ color: '#FAFAFA' }}>AI CRM</span>
            </a>
            ...
            <div className="flex items-center gap-3">
              <motion.button
                ...
                style={{ background: 'linear-gradient(135deg, #2563EB, #1D4ED8)', boxShadow: '0 2px 12px rgba(37, 99, 235, 0.4)' }}
              >
                Sign In
              ...
              >
                <span className={`block w-5 h-0.5 rounded-full transition-all duration-300 ${mobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`} style={{ background: '#FAFAFA' }} />
                <span className={`block w-5 h-0.5 rounded-full transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : ''}`} style={{ background: '#FAFAFA' }} />
                <span className={`block w-5 h-0.5 rounded-full transition-all duration-300 ${mobileMenuOpen ? '-rotate-45 -translate-y-2' : ''}`} style={{ background: '#FAFAFA' }} />
              </button>
            </div>
          </div>
      ...
      {/* ===== 2. HERO SECTION ===== */}
      <section ref={heroRef} className="relative pt-32 sm:pt-40 pb-20 sm:pb-32 overflow-hidden" style={{ background: '#09090B' }}>
        {/* Gradient blobs */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <motion.div variants={fadeUp}>
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold mb-6 border" style={{ background: 'rgba(37, 99, 235, 0.15)', color: '#38BDF8', borderColor: 'rgba(56, 189, 248, 0.3)' }}>
                  <Sparkles className="h-3 w-3" />
                  AI-Powered Email Intelligence
                </span>
              </motion.div>

              <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6" style={{ color: '#FAFAFA' }}>
                Your Gmail.{' '}
                <span className="gradient-text">Powered by AI.</span>
              </motion.h1>

              <motion.p variants={fadeUp} className="text-lg sm:text-xl leading-relaxed mb-8 max-w-lg" style={{ color: '#A1A1AA' }}>
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3">
                ...
                <motion.button
                  ...
                  style={{ color: '#FAFAFA', borderColor: '#27272A', background: '#18181B' }}
                >
                  <Play className="h-4 w-4" style={{ color: '#38BDF8' }} />
                  Watch Demo
                </motion.button>
              </motion.div>

              <motion.p variants={fadeUp} className="text-xs mt-4" style={{ color: '#71717A' }}>
      ...
      {/* ===== 3. TRUSTED BY ===== */}
      <section className="py-12 border-y" style={{ borderColor: '#27272A', background: '#0F0F12' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            variants={fadeIn}
            initial="hidden"
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-widest mb-6" style={{ color: '#71717A' }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              {TRUSTED_LOGOS.map((logo) => (
                ...
                >
                  {logo.svg}
                  <span className="text-sm font-medium" style={{ color: '#A1A1AA' }}>{logo.name}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      {/* ===== 4. FEATURES ===== */}
      <section id="features" className="py-24 sm:py-32" style={{ background: '#09090B' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            tag="Features"
          ...
          >
            {FEATURES.map((feature) => (
              ...
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-xl mb-4 transition-colors duration-300" style={{ background: 'rgba(37, 99, 235, 0.15)', border: '1px solid rgba(37, 99, 235, 0.3)' }}>
                  <feature.icon className="h-5 w-5 transition-colors duration-300" style={{ color: '#38BDF8' }} />
                </div>
                <h3 className="text-base font-semibold mb-2" style={{ color: '#FAFAFA' }}>{feature.title}</h3>
      ...
      {/* ===== 5. HOW IT WORKS ===== */}
      <section id="how-it-works" className="py-24 sm:py-32" style={{ background: '#0F0F12' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            tag="How It Works"
            ...
            >
              {STEPS.map((step, i) => (
                ...
                >
                  {/* Connector line */}
                  {i < STEPS.length - 1 && (
                    <div className="absolute left-[23px] top-[48px] bottom-0 w-[2px]" style={{ background: 'linear-gradient(to bottom, #2563EB, #38BDF8)', opacity: 0.3 }} />
                  )}
                  ...
                  <div className="pt-1.5">
                    <div className="flex items-center gap-2 mb-1.5">
                      <step.icon className="h-4 w-4" style={{ color: '#38BDF8' }} />
                      <h3 className="text-base font-semibold" style={{ color: '#FAFAFA' }}>{step.title}</h3>
                    </div>
                    <p className="text-sm leading-relaxed" style={{ color: '#A1A1AA' }}>{step.description}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
      ...
      {/* ===== 6. WHY CHOOSE AI CRM ===== */}
      <section id="why-choose" className="py-24 sm:py-32" style={{ background: '#09090B' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            tag="Why AI CRM"
          ...
          >
            {WHY_CARDS.map((card) => (
              <motion.div
                ...
                style={{ background: '#18181B', border: `1px solid ${card.borderColor}` }}
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl mb-6" style={{ background: card.iconBg }}>
                ...
                <p className="text-sm leading-relaxed" style={{ color: '#A1A1AA' }}>{card.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ===== 7. DEMO PREVIEW ===== */}
      <section id="demo" className="py-24 sm:py-32" style={{ background: '#0F0F12' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            tag="Demo"
          ...
          >
            ...
            <motion.div variants={fadeUp} className="landing-card overflow-hidden">
              <div className="px-4 py-3 flex items-center gap-2 border-b" style={{ borderColor: '#27272A', background: '#18181B' }}>
                <BarChart3 className="h-4 w-4" style={{ color: '#38BDF8' }} />
                <span className="text-xs font-semibold" style={{ color: '#FAFAFA' }}>Dashboard</span>
              </div>
              <div className="p-4 space-y-3" style={{ background: '#09090B' }}>
                ...
                <div className="space-y-1">
                  {['Revenue Report — John Smith', 'Design Review — Sarah Lee', 'PR #42 Merged — GitHub'].map((e, i) => (
                    <div key={i} className="flex items-center gap-2 px-2 py-1.5 rounded" style={{ background: '#18181B' }}>
                      <div className="h-5 w-5 rounded-full flex items-center justify-center text-[7px] font-bold shrink-0" style={{ background: 'rgba(37, 99, 235, 0.2)', color: '#38BDF8' }}>{e.split(' — ')[1]?.charAt(0) || 'G'}</div>
            ...
            <motion.div variants={fadeUp} className="landing-card overflow-hidden">
              <div className="px-4 py-3 flex items-center gap-2 border-b" style={{ borderColor: '#27272A', background: '#18181B' }}>
                ...
                <span className="text-xs font-semibold" style={{ color: '#FAFAFA' }}>AI Chat</span>
              </div>
              <div className="p-4 space-y-3" style={{ background: '#09090B' }}>
                {/* User message */}
                <div className="flex justify-end">
                  <div className="rounded-xl rounded-tr-sm px-3 py-2 max-w-[80%]" style={{ background: '#2563EB' }}>
                    <p className="text-[10px]" style={{ color: '#FAFAFA' }}>Summarize all emails from John this week</p>
                  </div>
                </div>
                {/* AI response */}
                <div className="flex justify-start">
                  <div className="rounded-xl rounded-tl-sm px-3 py-2 max-w-[85%]" style={{ background: '#18181B', border: '1px solid #27272A' }}>
                    <div className="flex items-center gap-1 mb-1">
                      <Sparkles className="h-2.5 w-2.5" style={{ color: '#38BDF8' }} />
                      <span className="text-[8px] font-semibold" style={{ color: '#38BDF8' }}>AI Assistant</span>
                    </div>
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg" style={{ background: '#18181B', border: '1px solid #27272A' }}>
                  ...
                  <Send className="h-3 w-3" style={{ color: '#38BDF8' }} />
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="landing-card overflow-hidden">
              <div className="px-4 py-3 flex items-center gap-2 border-b" style={{ borderColor: '#27272A', background: '#18181B' }}>
                <Mail className="h-4 w-4" style={{ color: '#38BDF8' }} />
                <span className="text-xs font-semibold" style={{ color: '#FAFAFA' }}>Email Detail</span>
              </div>
              <div className="p-4 space-y-3" style={{ background: '#09090B' }}>
                <div className="flex items-center gap-2">
                  <div className="h-7 w-7 rounded-full flex items-center justify-center text-[9px] font-bold" style={{ background: 'rgba(37, 99, 235, 0.2)', color: '#38BDF8' }}>J</div>
                  <div>
                ...
                <div className="flex gap-2">
                  <div className="flex-1 rounded-lg py-1.5 text-center text-[8px] font-semibold" style={{ background: 'rgba(37, 99, 235, 0.2)', color: '#38BDF8' }}>Reply with AI</div>
            ...
            <motion.div variants={fadeUp} className="landing-card overflow-hidden">
              <div className="px-4 py-3 flex items-center gap-2 border-b" style={{ borderColor: '#27272A', background: '#18181B' }}>
                <BarChart3 className="h-4 w-4" style={{ color: '#38BDF8' }} />
                <span className="text-xs font-semibold" style={{ color: '#FAFAFA' }}>Analytics</span>
              </div>
              <div className="p-4 space-y-3" style={{ background: '#09090B' }}>
                <div className="grid grid-cols-2 gap-2">
                  <div className="rounded-lg p-2" style={{ background: '#18181B', border: '1px solid #27272A' }}>
                  ...
                  <div className="rounded-lg p-2" style={{ background: '#18181B', border: '1px solid #27272A' }}>
                    ...
                    <p className="text-sm font-bold" style={{ color: '#38BDF8' }}>142</p>
                  </div>
                </div>
                {/* Mini bar chart */}
                  ...
                  <div className="flex items-end gap-1 h-12">
                    {[40, 65, 55, 80, 70, 90, 60].map((h, i) => (
                      <div
                        ...
                        style={{
                          height: `${h}%`,
                          background: i === 5 ? '#2563EB' : 'rgba(37, 99, 235, 0.3)',
                        }}
                      />
                    ))}
                  </div>
          ...
          >
            {TESTIMONIALS.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold text-white" style={{ background: 'linear-gradient(135deg, #2563EB, #1D4ED8)' }}>
                    {t.avatar}
                  </div>
                  <div>
                    <p className="text-sm font-semibold" style={{ color: '#FAFAFA' }}>{t.name}</p>
      ...
      {/* ===== 9. STATISTICS ===== */}
      <section className="py-24 sm:py-32" style={{ background: '#0F0F12' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            variants={stagger}
            initial="hidden"
                ...
                <p className="text-4xl sm:text-5xl font-extrabold mb-2 gradient-text">
                  {stat.isText ? (
                    <span className="flex items-center justify-center gap-2">
                      <Sparkles className="h-8 w-8" style={{ color: '#38BDF8' }} />
                    </span>
                  ) : (
                    <AnimatedCounter target={stat.value} suffix={stat.suffix} />
                  )}
                </p>
                <p className="text-sm font-medium" style={{ color: '#A1A1AA' }}>{stat.label}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 sm:py-32 cta-gradient">
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight mb-6" style={{ color: '#FAFAFA' }}>
              Ready to supercharge{' '}
              <span className="gradient-text">your Gmail?</span>
            </h2>

            <p className="text-lg leading-relaxed mb-10 max-w-xl mx-auto" style={{ color: '#A1A1AA' }}>
      ...
      {/* ===== 11. FOOTER ===== */}
      <footer className="py-12 border-t" style={{ borderColor: '#27272A', background: '#09090B' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            {/* Logo */}
            <div className="flex items-center gap-2.5">
              <LogoMark className="h-7 w-7" />
              <span className="text-sm font-bold" style={{ color: '#FAFAFA' }}>AI CRM Assistant</span>
            </div>
            ...
            <p className="text-xs" style={{ color: '#71717A' }}>
              Made by <span className="font-medium" style={{ color: '#A1A1AA' }}>Devang Singh</span>
            </p>
          </div>
        </div>
      </footer>
